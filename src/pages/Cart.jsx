...
const Cart = () => {
    ...
    const { products, currency, cardItems, removeFromCart, updateCartItems, getCartCount, getCartAmount, navigate } = useAppContext();
    ...
    return products.length > 0 && cardItems ? (
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        <p>Qty:</p>
                                        <select onChange={e => updateCartItems(product._id, Number(e.target.value))} value={cardItems[product._id]} className='outline-none'>
                ...
                <button onCanPlay={() => { navigate("/products"); scrollTo(0, 0) }} className="group cursor-pointer flex items-center mt-8 gap-2 text-primary font-medium">
