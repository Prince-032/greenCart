...
export const AppContextProvider = ({ children }) => {
    ...
    const value = { navigate, user, setUser, isSeller, setIsSeller, showUserLogin, setShowUserLogin, products, currency, addToCart, cardItems, updateCartItems, removeFromCart, searchQuery, setSearchQuery , getCartCount ,getCartAmount }
